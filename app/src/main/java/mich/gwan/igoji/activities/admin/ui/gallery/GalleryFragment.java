package mich.gwan.igoji.activities.admin.ui.gallery;
...
import mich.gwan.igoji.adapters.AllSale.AllsaleRecyclerAdapter;
import mich.gwan.igoji.adapters.pdf.PDFUtility;
import mich.gwan.igoji.databinding.FragmentGalleryBinding;
...
public class GalleryFragment extends Fragment implements PDFUtility.OnDocumentClose{
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Igoji/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_AllSales.pdf";
        }
        return path;
    }
   ...
   // private void deleteItem(int position) {
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_igoji_allsale_data.xls";
                    ...
                    if(froDatePicker.getText() != "" && toDatePicker.getText() != "" ) {
                        new AsyncTask<Void, Void, Void>() {
                            ...
                            protected void onPostExecute(Void aVoid) {
                                super.onPostExecute(aVoid);
                                recyclerAdapter.notifyDataSetChanged();
                                textNetProfit.setText(String.valueOf(databaseHelper.getAllSaleProfit((String) froDatePicker.getText(), (String) toDatePicker.getText(), textInputEditText.getText().toString().toUpperCase())));
                                textNetProfit.setText((String.valueOf(prof())));
                                textNetTotal.setText(String.valueOf(tot()));
                            }
                        }.execute();
