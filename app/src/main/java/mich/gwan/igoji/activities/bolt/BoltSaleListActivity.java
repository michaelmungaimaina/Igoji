package mich.gwan.igoji.activities.bolt;
...
import mich.gwan.igoji.adapters.bolt.BoltSaleRecyclerAdapter;
import mich.gwan.igoji.adapters.pdf.PDFBolt;
import mich.gwan.igoji.databinding.ActivityBoltssalesListBinding;
...
public class BoltSaleListActivity extends AppCompatActivity implements PDFBolt.OnDocumentClose{
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Igoji/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_BoltSales.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_kithimu_bolt_sale_data.xls";
        String filePath = Environment.getExternalStorageDirectory().getPath() + "/Sarensa/Kithimu/" + filename;
