package mich.gwan.igoji.activities.gas;
...
import mich.gwan.igoji.adapters.pdf.PDFGas;
import mich.gwan.igoji.databinding.ActivityGassalesListBinding;
...
public class GasSaleListActivity extends AppCompatActivity implements PDFGas.OnDocumentClose{
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Igoji/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_GasSales.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_igoji_gas_sale_data.xls";
