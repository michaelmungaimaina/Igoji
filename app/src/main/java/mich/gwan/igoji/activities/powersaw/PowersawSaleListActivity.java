package mich.gwan.igoji.activities.powersaw;
...
import mich.gwan.igoji.adapters.pdf.PDFPowersaw;
import mich.gwan.igoji.adapters.powersaw.PowersawSaleRecyclerAdapter;
import mich.gwan.igoji.databinding.ActivityPowersawsalesListBinding;
...
public class PowersawSaleListActivity extends AppCompatActivity implements PDFPowersaw.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Igoji/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_powersaw.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_igoji_powersaw_sale_data.xls";
