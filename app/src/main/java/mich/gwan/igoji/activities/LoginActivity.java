package mich.gwan.igoji.activities;
...
import mich.gwan.igoji.activities.admin.ControlActivity;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.textViewLinkRegister:
                ...
                Intent intentRegister = new Intent(getApplicationContext(), mich.gwan.igoji.activities.RegisterActivity.class);
    ...
    private void verifyFromSQLite() {
            ...
            if (databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim(), textInputEditTextPassword.getText().toString().trim())) {
                ...
                Snackbar snackbar = Snackbar.make(nestedScrollView,  "Igoji Session Opened Successfully", Snackbar.LENGTH_LONG);
