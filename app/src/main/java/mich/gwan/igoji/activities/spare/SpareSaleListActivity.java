package mich.gwan.igoji.activities.spare;
...
import mich.gwan.igoji.adapters.pdf.PDFSpare;
import mich.gwan.igoji.adapters.spare.SpareSaleRecyclerAdapter;
import mich.gwan.igoji.databinding.ActivitySparesalesListBinding;
...
public class SpareSaleListActivity extends AppCompatActivity implements PDFSpare.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Igoji/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_spare.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_igoji_spare_sale_data.xls";
