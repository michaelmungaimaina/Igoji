...
import mich.gwan.igoji.adapters.pdf.PDFWelding;
import mich.gwan.igoji.adapters.welding.WeldingSaleRecyclerAdapter;
import mich.gwan.igoji.databinding.ActivityWeldingsalesListBinding;
...
public class WeldingSaleListActivity extends AppCompatActivity implements PDFWelding.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Igoji/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_welding.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_igoji_welding_sale_data.xls";
