package mich.gwan.igoji.activities.oil;
...
import mich.gwan.igoji.activities.LoginActivity;
import mich.gwan.igoji.activities.gas.GasSaleListActivity;
import mich.gwan.igoji.adapters.gas.GasSaleRecyclerAdapter;
import mich.gwan.igoji.adapters.oil.OilSaleRecyclerAdapter;
import mich.gwan.igoji.adapters.pdf.PDFOil;
import mich.gwan.igoji.databinding.ActivityOilsalesListBinding;
...
public class OilSaleListActivity extends AppCompatActivity implements PDFOil.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Igoji/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_OilSales.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_igoji_oil_sale_data.xls";
